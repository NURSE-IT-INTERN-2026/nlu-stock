...
**ตอนนี้ใช้แค่ 3 flow** (21, 25, 26 ดูคอลัมน์ ยันอะไร ในตารางข้างล่าง) ที่เหลือยังยันแค่ผลลัพธ์ปลายทาง
(สถานะ/ยอดใน DB) ยังไม่ได้ยันว่าหน้าประวัติแสดงถูก
...
### มีอะไรอยู่บ้าง — 26 ไฟล์ / 39 scenario
...
| 02 | `02-add-item` | สร้างรายการที่นับรายชิ้น | wizard ออกรหัส + C01–C03 + รอบเวลา |
...
| 12 | `12-return-damaged` | คืนพร้อมสภาพชำรุด | คืน + เปิดเคสซ่อม |
