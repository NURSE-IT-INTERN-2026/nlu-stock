...
// วินาทีที่มันเกิด — และเป็นใบเดียวกับที่ /cases เปิดอยู่แล้ว. ห้ามใช้เกณฑ์นี้กับเคส known:
// การยืมที่ยังไม่คืนสักชิ้น (ใบที่คนตามหา) จะกลายเป็นแถวเปล่าไม่มีเลขเคส.
