...
//
// หน้านี้มีแต่รายงานที่นับรวมได้ทั้งคลัง — เคสของชิ้นใดชิ้นหนึ่งอ่านที่แท็บประวัติในหน้าพัสดุ
// งานค้างอยู่ที่ /alerts?todo=true. แต่ละ tab ไม่มีหัวเรื่อง/คำโปรย ชื่อบน tab บอกครบแล้ว.
const TABS = [
