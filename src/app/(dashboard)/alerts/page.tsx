...
//
// ทุกแท็บที่เหลือ render ตารางพัสดุ. ห้ามเพิ่มแท็บคิวงานที่ต้องลงมือทำ — เกินกำหนดคืนอยู่
// /receive?tab=return&due=overdue, ชำรุดรอส่งซ่อมอยู่ /repairs, เกินกำหนดบำรุงอยู่ /maintenance
// ซึ่งกดทำงานได้จริง ที่นี่จะเป็นแค่สำเนาที่กดอะไรไม่ได้. งานค้างเห็นได้ที่แท็บ `todo`.
